...
void ClassicFlangerUI::_drawChassisBackground(float margin, float rounding)
{
    ...
    // Main panel – base colour RGB(65, 65, 103)
    drawList->AddRectFilled(panelMin, panelMax, IM_COL32(65, 65, 103, 0xff), rounding);
...
void ClassicFlangerUI::_drawPluginName()
{
    ...
    //
    // "RE-01" model mark: capsule split into two halves.
    // Left  half – transparent background, white "RE".
    // Right half – solid white background,  black "01".
    //
    {
